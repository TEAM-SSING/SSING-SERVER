...
INSERT INTO instructor_profiles (
    ...
    (
        ...
        'FEMALE',
        '2000-01-01',
        '처음 스키를 타는 분도 편하게 따라올 수 있도록 기본 자세부터 차근차근 알려드려요.',
        '2025-12-15',
        1,
        NULL,
        0,
    ...
    (
        ...
        'MALE',
        '2000-01-02',
        '하이원에서 기초부터 중급 턴까지, 각자의 속도에 맞춰 즐겁고 안전하게 함께합니다.',
        '2024-12-10',
        1,
        NULL,
        0,
    ...
    (
        ...
        'FEMALE',
        '2000-01-03',
        '중급 기술부터 레벨 테스트 준비까지, 동작의 원리를 이해하기 쉽게 짚어드려요.',
        '2014-12-01',
        1,
        NULL,
        0,
    ...
    (
        ...
        'FEMALE',
        '2000-01-04',
        '스키가 처음이어도 괜찮아요. 비발디파크에서 멈추기와 방향 전환부터 편안하게 알려드려요.',
        '2026-01-15',
        1,
        NULL,
        0,
