...
public record BaseResponse<T>(
    ...
    // validation 실패 응답
    public static BaseResponse<Void> error(ErrorCode errorCode, Map<String, String> errors, String traceId) {
        return new BaseResponse<>(false, errorCode.getCode(), errorCode.getMessage(), null, errors, traceId);
    }
}
