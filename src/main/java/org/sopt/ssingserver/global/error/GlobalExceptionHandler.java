...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<BaseResponse<Void>> handleMethodArgumentNotValid(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(BaseResponse.error(CommonErrorCode.VALIDATION_FAILED, resolveTraceId(request)));
    }
    ...
    public ResponseEntity<BaseResponse<Void>> handleException(
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(BaseResponse.error(CommonErrorCode.INTERNAL_ERROR, resolveTraceId(request)));
    }
